...
#create my boi polygon
polygon = Polygon() #creates my boi polygon
thatPosition = [200,200]
polygon2 = Polygon(thatPosition)
screen.blit(polygon.image, polygon.position) #places my boi
screen.blit(polygon2.image, polygon2.position)
