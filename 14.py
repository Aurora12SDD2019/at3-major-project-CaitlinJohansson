...
P.mixer.music.load('media/Zero_Hour.mp3') #All rights and credit to Destiny 2 and its creators over at Bungie
P.mixer.music.play() #this is to allow the music to play throughout the entirety of te game until closed
