...
block_rate = 1500  # time in millisecs between adding platforms
...
while play:  # game loop - note:  everything in this loop is indented one tab
    ...
    if Helping:
        ...
        for platform in P_Array:
            ...
            if (platform.rect.colliderect(Sprite_Polygon.rect) and Sprite_Polygon.downwards):
